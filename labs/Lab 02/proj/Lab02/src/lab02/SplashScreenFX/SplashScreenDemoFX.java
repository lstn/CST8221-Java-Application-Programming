...
public class SplashScreenDemoFX extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    primaryStage.setScene(new Scene(new Button("Application Stage"), 400, 200));        
    // Display the splash stage
    splashStage.show(); 
    /*The following code makes sure that the stages are displayed in proper order.
      The splash stage is closed after initial some delay and the primary stage is displayed.
