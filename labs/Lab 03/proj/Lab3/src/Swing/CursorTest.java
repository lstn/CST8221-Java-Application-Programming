...
public class CursorTest extends JFrame {
 ...
 private static final long serialVersionUID = 1L; 
    ...
    private static String FRAME_TITLE = "Cursor Test";
...
/*******************************/
           ++cursorCounter;
	   Cursor newCursor = Cursor.getPredefinedCursor(cursorCounter);
	   
	   // set the button cursor here: call setCursor() on the button
	   /* add code here */
           
           button.setCursor(newCursor);
           label_02.setText(labelText + button.getCursor().getName());
